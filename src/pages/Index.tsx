...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section 
        ref={heroRef} 
        className="pt-24 sm:pt-28 md:pt-32 lg:pt-40 pb-16 sm:pb-20 md:pb-24 lg:pb-32 px-4 bg-gradient-to-b from-background to-secondary/20"
      >
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <p className="mt-4 md:mt-6 text-base sm:text-lg md:text-xl text-muted-foreground animate-fade-in" style={{ animationDelay: '0.2s' }}>
                Get instant estimates, explore premium fixtures, and transform your washroom with our interactive design calculator.
              </p>
              <div className="mt-6 md:mt-10 flex flex-col sm:flex-row justify-center md:justify-start gap-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="md:w-1/2 animate-fade-in mt-8 md:mt-0" style={{ animationDelay: '0.3s' }}>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-secondary/30">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="md:w-1/2 reveal opacity-0 mt-8 md:mt-0" style={{ animationDelay: '0.2s' }}>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-primary-foreground/80 mb-6 sm:mb-8 md:mb-10 max-w-2xl mx-auto reveal opacity-0" style={{ animationDelay: '0.1s' }}>
            Get started today with our design calculator and take the first step towards your dream washroom.
          </p>
          <Button 
            size={isMobile ? "default" : "lg"} 
            variant="secondary" 
            className={`text-base md:text-lg ${isMobile ? "px-4 py-2" : "px-8 py-6"} reveal opacity-0`}
